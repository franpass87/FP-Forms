...
### Core Features
- **Form Builder Drag & Drop** - Crea form personalizzati con facilità; interfaccia admin con titolo in alto, palette tipi a sinistra, elenco campi al centro, aspetto e avanzate sotto, empty state e salvataggio in evidenza
