...
= 1.6.12 = (2026-03-23)
* Changed: Menu admin - ordine voci (Operatività, Gestione, Sistema), separatori visivi e link rapidi admin bar (pattern FP-Experiences).

= 1.6.11 = (2026-03-23)
* Changed: Brevo - fallback lingua per lista da locale WP/WPML/Polylang.
